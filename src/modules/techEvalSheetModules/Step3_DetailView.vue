  ...
  <div class="flex flex-col space-y-8 px-7 py-7 bg-blue-50 rounded">
    ...
    >
      ...
      <div class="font-normal">
        {{ Step3_detailObj.evalIndex }}
      </div>

      <div v-if="Step3_detailObj.evalIndex_Num === '1'" class="flex-col">
      <div class="flex font-normal">
        <li class="font-normal list-disc"></li>{{ Step3_detailObj.evalIndex_content1 }}
      </div>
      </div>

      <div v-if="Step3_detailObj.evalIndex_Num === '2'" class="flex-col">
        <div class="flex font-normal">
        <li class="font-normal list-disc"></li>{{ Step3_detailObj.evalIndex_content1 }}
      </div>
      <div class="flex font-normal">
        <li class="font-normal list-disc"></li>{{ Step3_detailObj.evalIndex_content2 }}
      </div>
      </div>

      <div v-if="Step3_detailObj.evalIndex_Num === '3'" class="flex-cold">
        <div class="flex font-normal">
        <li class="font-normal list-disc"></li>{{ Step3_detailObj.evalIndex_content1 }}
      </div>
      <div class="flex font-normal">
      ...
      <div v-if="Step3_detailObj.reviewItems === '1'" class="pt-5 flex-col">
      ...
      <div v-if="Step3_detailObj.reviewItems === '2'" class="pt-5 flex-col">
      <div class="font-semibold mb-2">검토항목</div>
      ...
      <div v-if="Step3_detailObj.reviewItems === '3'" class="pt-5 flex-col">
      <div class="font-semibold mb-2">검토항목</div>
    ...
    <fieldset>
      ...
      <div class="space-y-5">
        <div
          v-for="scoreOption in Step3_detailObj.scoreSelect"
    ...
    >
      ...
      <div v-if="appStore.task[stepname]?.평가근거.length > 0">
      <li class="font-normal list-disc">
        {{ appStore.task[stepname]?.평가근거 || "" }}
      </li>
      </div>
      <div v-else>tsgsg</div>
    </div>
...
const stepname = props.Step3_detailObj.stepname;
